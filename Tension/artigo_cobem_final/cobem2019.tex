...
From this sketch, a 3D model was designed on the CATIA V5 CAD software (Figure \ref{fig2}). Such model was then exported as an STL file to the slicing software (Simplify3D), as seen on Fig.\ref{fig3}.
...
The results were close to other test executed in literature as seen in \citep{PETG}. But in these tests the overall Young's modulus were measured around 0.7 GPa. So the results were slightly higher, possibly because of different printing and filament qualities. 
