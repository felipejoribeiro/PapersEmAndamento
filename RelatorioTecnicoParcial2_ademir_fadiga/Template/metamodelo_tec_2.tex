...
% ---> Formatação estilo fortran para o pacote listings
%\definecolor{mygray}{rgb}{0.96,0.96,0.96}
%\definecolor{mygreen}{rgb}{0, 0.360, 0.050}
...
\begin{document}
	...
	\begin{normalsize}
		\begin{description}
			...
			%\item[Vice-coordenador:] Prof. Dr. Roberto Mendes Finzi Neto \\   
