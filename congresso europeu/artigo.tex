...
It was obtained a turbulent Prandtl number, for the turbulent Reynolds number $ 1020$, of $ 0.89999 $ .
\begin{figure}[!h]
	\centering
	\includegraphics[angle=0, scale=0.31]{fotos_formatacao_final/Genetic_amostra}
	\caption{Genetic algorithm iterations, with simulations for $Re_\tau = 1020$. Convergence on $Pr_t = 0.89999 $.}
\end{figure}
...
\begin{figure*}[!h]
	...
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
		\includegraphics[angle=0, scale=0.3]{fotos_formatacao_final/Temperature_150_071_Prt(Ret)_A26}
		\caption{Temperature distribution for $Re_\tau = 150$, $L2 = 0.34$}
	\end{subfigure}
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\includegraphics[angle=0, scale=0.3]{fotos_formatacao_final/Temperature_395_071_Prt(Ret)_A26}
		\caption{Temperature distribution for $Re_\tau = 395$, $L2 = 0.23$}
	\end{subfigure}
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
		\includegraphics[angle=0, scale=0.3]{fotos_formatacao_final/Temperature_640_071_Prt(Ret)_A26}
		\caption{Temperature distribution for $Re_\tau = 640$, $L2 = 0.19$}
	\end{subfigure}
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\includegraphics[angle=0, scale=0.3]{fotos_formatacao_final/Temperature_1000_071_Prt(Ret)_A26}
		\caption{Temperature distribution for $Re_\tau = 1020$, $L2 = 0.14$}
	\end{subfigure}	
	\caption{Results for $Pr_t = 0.89999$, $A = 26$ and $Pr =0.71$ }
\end{figure*}
...
%\begin{table}[!h]
%	\centering
%	\caption{Comparison between The L2 norm from The simulations with $Pr_t =0.8999$ and $Pr_t(Re_\tau)$}
%	\begin{tabular}{lll}
%		\hline
%		150  &   0.34 &    \\
%		395  &   0.23 &    \\
...
\begin{figure*}[!h]
	...
	\begin{subfigure}[t]{0.5\textwidth}
		...
		\caption{Temperature distribution for $Re_\tau = 640$, $L2 = 0.174$}
	\end{subfigure}
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		...
		\caption{Temperature distribution for $Re_\tau = 1020$, $L2 = 0.14$}
	\end{subfigure}	
	\caption{Results for $Pr_\tau(Ret)$, $A = 26$ and $Pr =0.71$ }
\end{figure*}
...
\begin{figure*}[!h]
	...
	\end{subfigure}	
	\caption{Results for A modeled}
\end{figure*}

Simulations on the temperature, with the Cebeci's constant adjusted will be carried and discussed on the results section.

It was also studied the influence of the molecular Prandtl number and it was observed that it was also a variable with influences in the error of the method, thus a study was developed with the objective of adding the influence of the value of Prandtl number to the parameterization of the turbulent Prandtl number. For this the following model was proposed:
\begin{equation}
\begin{split}
