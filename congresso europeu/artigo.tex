...
Another method of adjustment on differential evolution is the multi objective adjustment. Such approach is used to model more then one variable simultaneously, for a minimal value in another variable of interest. This method was used to adjust the Cebeci's constant and the Turbulent Prandtl number for the minor error, for each DNS sample:
