...
%		\end{subfigure}%
		\begin{subfigure}[t]{0.49\textwidth}
		\centering
		\includegraphics[angle=0, scale=0.26]{fotos_formatacao_final/Temperature_150_071_classico}
...
\begin{figure}[!h]
	\centering
	\includegraphics[angle=0, trim = {20mm 0mm 0mm 15mm} , clip , scale=0.5]{fotos_formatacao_final/gerais}
...
\begin{thebibliography}{99} % Bibliography - this is intentionally simple in this template
	...
	\bibitem{John}
	\newblock{John C. S., Edward O. and Tamas T.},
	...
	\bibitem{DNS150}
	Kasagi H., Horiuti K., Miyake Y., Miyauchi T. and Nagano Y.,
	...
	\bibitem{Cengel}
	\newblock{Cengel Y. A. and Cimbala J. M.},
	...
	\bibitem{Luigi}
	Antonialli L. A. and Silveira A. N.,
	\newblock{Theoretical study of fully develop turbulent flow in a flat channel, using prandtl's mixing length model},
	\newblock{2015}.
	
	\bibitem{diferential}
	Price K. V., Storn M. R. and Lampinen A. J.,
